//
//  TestLagringTableViewController.swift
//  FaghelgApp
//
...
class TestLagringTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func getFetchedResultsController() -> NSFetchedResultsController{
        fetchedResultController = NSFetchedResultsController(fetchRequest: responsibleTaskRequest(), managedObjectContext: managedObjectContext!, sectionNameKeyPath: nil, cacheName: nil)
